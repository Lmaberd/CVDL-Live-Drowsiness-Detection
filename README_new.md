...
4. **Fusion MLP**: Predicts probability of drowsiness (0.0 to 1.0).

5. **Temporal Engine**: Smooths the probability over time and calculates PERCLOS.
